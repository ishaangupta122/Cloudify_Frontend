...
function FeatureCard({ image, title, description }: FeatureCardProps) {
  return (
    <div className="bg-[#FAF9FF] rounded-xl px-6 py-10 hover:shadow-lg transition-shadow duration-300 md:last:col-span-2 xl:last:col-span-1">
...
function TemplateCard({ image, title, description }: FeatureCardProps) {
  return (
    <div className="bg-[#FAF9FF] flex flex-col justify-between rounded-3xl hover:shadow-lg transition-shadow duration-300 pt-14 md:last:col-span-2 xl:last:col-span-1">
      ...
      <div className="mt-8 w-[85%] ml-auto">
        <img
          src={image}
          alt={`${title} image`}
...
function SecurityCard({ image, title, description }: FeatureCardProps) {
  return (
    <div className="bg-[#FAF9FF] rounded-3xl px-6 py-14 hover:shadow-lg transition-shadow duration-300">
      <div className="flex justify-start mb-6">
        <div className="w-16 h-16 rounded-full mb-3">
          <img
            src={image}
...
function SDNIntegrationSection() {
  return (
    <div className="container">
      ...
      {/* Description */}
      <p className="text-lg text-[#333333] max-w-5xl mb-12 leading-relaxed">
...
function MonetizationTemplatesSection() {
  return (
    <div className="container">
      <h2 className="text-3xl md:text-4xl font-semibold text-center text-[#111111] mb-8">
        {heroData.monetizationTemplates.title}
      </h2>
      <p className="text-lg text-[#333333] text-center mb-16 leading-relaxed">
...
function SecuritySection() {
  return (
    <div className="container">
      ...
      <p className="text-lg text-[#333333] text-center mb-16 leading-relaxed max-w-4xl mx-auto">
